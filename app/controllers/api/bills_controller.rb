class Api::BillsController < ApplicationController
  ...
  def create
    ...
    if @bill.save
      ...
      #Billsplit.create(bill_id: @bill.id, recipient_id: bill_params[:recipients][1], split_amount: split.round(2) )
      #Billsplit.create(bill_id: @bill.id, recipient_id: bill_params[:recipients][2], split_amount: split.round(2) )
